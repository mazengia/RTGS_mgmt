package com.rtgs.rtgsapi.security;

import com.rtgs.rtgsapi.utils.ApplicationProps;
...
public class SecurityConfig  {
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        return (web) -> web.ignoring().requestMatchers("/swagger-ui/**", "/v3/api-docs/**","/swagger-ui.html","/other-branch/**");
    }
